...
<form action="poll.php" method="POST">
		<h2>What is the best flavor?</h2>
			<table>
			<label for="text">Chocolate</label>
			<input type="radio" name="polloption" value= "question"><br><a> <?php echo $votes['votes']?><a>votes</a>
			<br>
			<label for="text">Vanilla</label>
			<input type="radio" name="polloption" value= "question"><br><a><?php echo $votes['votes']?><a>votes</a>
		<tr><td><input type="submit" name="vote" value="Vote" /></td></tr>
		<br>
	<center><a href="viewusers.php"class="txt2">
        View all
    </a></center>
				</form>
			</table>